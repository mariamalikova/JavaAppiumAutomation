...
public class FirstTests {
	...
	public void saveTwotArticlesToMyList() {
		...
		String search_xpath = "//*[contains(@text, '" + first_article_title + "')]";
		waitForElementAndClick(
		...
		// no thanks id	android:id/button2
		waitForElementAndClick(
		...
		// перейти на список  accessibility id	My lists    content-desc	My lists
		waitForElementAndClick(
		...
		Assert.assertTrue("There is no search results on the screen", search_results.size()==2);
	...
	public void testChangeScreenOrientationOnSearchResults(){
		...
		Assert.assertEquals("Article title have been changed after rotation", title_after_rotation, title_after_second_rotation);
