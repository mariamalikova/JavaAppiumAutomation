...
public class ArticlePageObject extends MainPageObject {
	...
	private static final String
			...
			GO_BACK_BUTTON = "//android.widget.ImageButton[@content-desc='Navigate up']",
			OVERFLOW_MENU_BUTTON = "//*[@resource-id='org.wikipedia:id/page_toolbar_button_show_overflow_menu']",
			OVERFLOW_FEED_BUTTON = "//*[@resource-id='org.wikipedia:id/page_action_overflow_feed']",
	...
	public void addArticleToBookmarks(String list_name){
		...
		this.waitForElementAndClick(By.xpath("//*[contains(@text, '" + list_name + "')]"), "Cannot find folder " + list_name, 5);
	}

	public void returnToMainScreen(){

		this.waitForElementAndClick(By.xpath(OVERFLOW_MENU_BUTTON), "There is no menu button on the screen", 5);
		this.waitForElementAndClick(By.xpath(OVERFLOW_FEED_BUTTON), "There is no feed button on the screen", 5);
